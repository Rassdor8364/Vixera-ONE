...
pub use credentials::{is_vixera_credential_key, ChunkedCredentialStore, CredentialError, CredentialStore, InMemoryCredentialStore, UnavailableCredentialStore, CREDENTIAL_SERVICE};
